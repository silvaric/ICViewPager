 ...
 * ViewPagerOptionTabOffsetY: Tab bar's Y offset from Bottom, defaults to 0.0
 * ViewPagerOptionTabWidth: Any tab item's width, defaults to 128.0
 * ViewPagerOptionTabsSpacing: The spacing to use between item's, defaults to 0.0
 ...
 * ViewPagerOptionTabSwipeEnabled: 1.0: YES, 0.0: NO, disable scrolling when tabs view swiped. Defaults to YES
 * ViewPagerOptionIgnoreTopLayoutGuide: 1.0: YES, 0.0: NO, ignore top layout view. Defaults to NO
...
typedef NS_ENUM(NSUInteger, ViewPagerOption) {
    ...
    ViewPagerOptionTabOffsetY,
    ViewPagerOptionTabWidth,
    ViewPagerOptionTabsSpacing,
    ...
    ViewPagerOptionCleanOutSightContents
};
